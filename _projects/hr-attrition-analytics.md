...
<img src="/assets/img/hr-power-query-cleaning.png" alt="Power Query data cleaning and column profiling" class="img-fluid rounded mx-auto d-block" style="max-width: 60%;">
