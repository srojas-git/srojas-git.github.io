...
<img src="/assets/img/hr-power-query-cleaning.png" alt="Power Query data cleaning and column profiling" class="img-fluid rounded mx-auto d-block" style="max-width: 70%;">
...
![VBA-generated Data Quality Report](/assets/img/hr-vba-quality-report.png)
...
![Final Power BI dashboard — Executive Summary and Operational Drivers](/assets/img/hr-powerbi-dashboard-final.png)
