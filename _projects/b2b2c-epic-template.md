---
layout: page
title: "B2B2C Platform Governance: Standardized Epic Template for API Delivery"
description: Org-wide Core Epic Template that eliminated discovery-during-grooming and recovered 4+ hours per sprint
...
- **Tech Stack:** Jira, Confluence, REST API standards, CI/CD documentation, Agile/Scrum governance
