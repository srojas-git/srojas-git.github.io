---
layout: page
title: Cross-Team Dependency Mapping & Stakeholder Governance
description: Interactive stakeholder dependency mapping tool that cut blocker escalation time from 3 days to same-day
...
- **Tech Stack:** AI-assisted rapid prototyping, org-chart-driven dependency visualization, cross-team stakeholder governance
...
## My Role
This wasn't in my job description or assigned to my backlog. As Product Owner for the Experience Platform team, I spotted an operational pattern hurting overall program velocity and took the initiative to solve it, driving value far beyond my primary scope.
